              ...
              <div className="elementor-element elementor-element-4485bc9 specification-gate elementor-widget elementor-widget-text-editor">
                <div className="elementor-widget-container">
                  <div style={{ color: '#ffffff' }}>
                    ...
                    From consultation to installation and maintenance, we provide end-to-end solar energy services tailored to your needs.    </p>
                    ...
                    <div className="flex items-center gap-2 mb-4">
                      <Image
                        ...
                        height={21}
                      />
                      <span>Reduction of Energy Losses</span>
                    </div>
                    <div className="flex items-center gap-2 mb-4">
                      <Image
                        className="alignnone wp-image-2092"
