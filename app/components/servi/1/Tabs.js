...
// import SCard from '@/app/components/servi/1/SCard';
// import ACard from '@/app/components/servi/1/ACard';
// import PCard from '@/app/components/servi/1/PCard';
...
const Tabs = () => {
  const [ setIsHovered] = useState(false); // Correctly destructured
  const [activeTab, setActiveTab] = useState("PCard");
