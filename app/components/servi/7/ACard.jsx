            ...
            <div className="w-80 pl-3">
              ...
              <div className="elementor-widget-container">
                <div style={{ color: '#ffffff' }}>
                  ...
                  Dedicated to creating intelligent living environments, we specialize in delivering user-friendly, secure, and innovative home automation solutions.
                  </p>
                  ...
                  <div className="flex items-center gap-2 mb-4">
                    <Image
                      ...
                      height={21}
                    />
                    <span>Automated Blinds and Curtains</span>
                  </div>
                </div>
              </div>
