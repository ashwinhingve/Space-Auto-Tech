          ...
          <div className="flex respo items-center justify-center space-x-8">
            ...
            <div className="w-80 pl-3">
              <div className="elementor-widget-container">
                ...
                Driving Energy Transformation with Expertise and Innovation
                </h2>
              </div>
              ...
              <div className="elementor-widget-container">
                <div style={{ color: '#ffffff' }}>
                  ...
                  We are committed to shaping the future of the power sector through sustainable practices and cutting-edge technologies. Our mission is to deliver reliable, affordable, and eco-friendly energy solutions that fuel progress and protect the planet.
                  </p>
                  ...
                  <div className="flex items-center gap-2 mb-4">
                    <Image
                      ...
                      height={10}
                    />
                    <span>Decentralized Power Solutionsn</span>
                  </div>
                  <div className="flex items-center gap-2 mb-4">
                    <Image
                      src="https://waarta.waartaconnections.com/wp-content/uploads/2023/12/Ellipse-13-1.webp"
                      ...
                      height={21}
                    />
                    <span>Energy Efficiency Initiatives</span>
                  </div>
                </div>
              </div>
