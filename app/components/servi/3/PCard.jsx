...
const PCard = () => {
  return (
    <>
      <section>
        <div id="1" className="e-con-inner bg-gradient-to-r from-blue-600 to-teal-500 rounded-xl p-8 shadow-xl transform transition-transform hover:scale-105">
            ...
            <div className="elementor-element elementor-element-39d258f e-con-full e-flex e-con e-child w-80 pl-3">
              <div className="elementor-element elementor-element-ccaca41 elementor-widget elementor-widget-heading">
                <div className="elementor-widget-container">
                  ...
                  Innovative Energy Solutions for a Brighter Tomorrow
                  </h2>
                </div>
              </div>
              ...
              <div className="elementor-element elementor-element-4485bc9 specification-gate elementor-widget elementor-widget-text-editor">
                <div className="elementor-widget-container">
                  <div style={{ color: '#ffffff' }}>
                    ...
                    Discover cutting-edge products designed to revolutionize energy generation, storage, and distribution. From advanced turbines to efficient energy storage systems, our solutions empower industries and communities with sustainable and reliable power.
                    </p>
                    ...
                    <div className="flex items-center gap-2 mb-4">
                      <Image
                        ...
                        height={10}
                      />
                      <span>Hybrid Energy Systems</span>
                    </div>
                    <div className="flex items-center gap-2 mb-4">
                      <Image
                        className="alignnone wp-image-2092"
