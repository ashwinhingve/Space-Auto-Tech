            ...
            <div className="elementor-element elementor-element-39d258f e-con-full e-flex e-con e-child w-80 pl-3">
              <div className="elementor-element elementor-element-ccaca41 elementor-widget elementor-widget-heading">
                <div className="elementor-widget-container">
                  ...
                  Comprehensive Power Sector Services for Sustainable Growth
                  </h2>
                </div>
              </div>
              ...
              <div className="elementor-element elementor-element-4485bc9 specification-gate elementor-widget elementor-widget-text-editor">
                <div className="elementor-widget-container">
                  <div style={{ color: '#ffffff' }}>
                    ...
                    From system design and installation to maintenance and optimization, our services ensure seamless energy operations. We specialize in renewable energy integration, grid modernization, and advanced analytics to maximize efficiency and reliability.
                    </p>
                    ...
                    <div className="flex items-center gap-2 mb-4">
                      <Image
                        ...
                        height={21}
                      />
                      <span>Carbon Neutrality Goals</span>
                    </div>
                    <div className="flex items-center gap-2 mb-4">
                      <Image
                        className="alignnone wp-image-2092"
                    ...
                    <div className="flex items-center gap-2 mb-4">
                      <Image
                        ...
                        height={21}
                      />
                      <span>Offshore Energy Projects</span>
                    </div>
                  </div>
                </div>
              </div>
