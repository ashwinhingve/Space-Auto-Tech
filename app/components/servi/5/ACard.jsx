          ...
          <div className="flex respo items-center justify-center space-x-8">
            ...
            <div className="w-80 pl-3">
              <div className="elementor-widget-container">
                ...
                About Us: Redefining Railway Automation
                </h2>
              </div>
              ...
              <div className="elementor-widget-container">
                <div style={{ color: '#ffffff' }}>
                  ...
                  We are a forward-thinking company dedicated to transforming the railway sector through automation and technology.
                  </p>
                  ...
                  <div className="flex items-center gap-2 mb-4">
                    <Image
                      ...
                      height={21}
                    />
                    <span>Customer-Centric Values</span>
                  </div>
                </div>
              </div>
