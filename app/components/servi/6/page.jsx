...
const irrigationData = [
  {
    ...
    description:
      "Discover the tools and technologies shaping tomorrow’s web experiences. Learn how to create responsive, accessible, and innovative websites.",
  ...
  {
    id: 2,
    title: "Explore Cutting-Edge Web Technologies",
    description:
      "Dive into the latest advancements in web development, from frameworks to tools, and stay ahead in the ever-evolving digital world.",
    listItems: ["Web Solutions for Every Challenge", "Code Your Vision Into Reality"],
    link: "#",
    imageSrc: "/images/dev2.jpg",
  },
  {
    id: 3,
    title: "Gain the skills and expertise needed to design, code, and deploy robust web applications using industry-leading practices.",
    description:
...
const IrrigationCards = () => {
  return (
    <section className="py-10 bg-gray-100">
      ...
      Bring your concepts to life with innovative, user-friendly, and responsive web designs that leave a lasting impression.
        <span className="bg-sky-400 border-none shadow-blue-400 rounded-sm shadow-lg font-semibold pl-2">
          Transforming Ideas Into Digital Reality From Blueprint to Browser.
        </span>
      </p>
        ...
        <div className="flex flex-col lg:flex-row justify-center items-center lg:items-start mb-8 lg:mb-16 space-y-8 lg:space-y-0">
          ...
          <div className="w-full lg:w-1/2 flex flex-col items-center lg:items-start text-center lg:text-left space-y-6">
            <h3 className="text-2xl sm:text-3xl font-bold font-sans leading-tight">
              About SPACE AUTOMATION Development
            </h3>
            <ul className="text-lg sm:text-xl space-y-3 font-serif">
              <li>✅ Empowering Brands Through Web Excellence</li>
              <li>✅ Empower Your Online Presence</li>
              <li>✅ Digital Craftsmanship at Its Best</li>
            </ul>
            < Link
