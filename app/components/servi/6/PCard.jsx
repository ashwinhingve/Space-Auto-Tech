              ...
              <div className="elementor-element elementor-element-ccaca41 elementor-widget elementor-widget-heading">
                <div className="elementor-widget-container">
                  <h2 className="text-4xl font-extrabold text-white mb-4 text-transparent bg-clip-text bg-gradient-to-r from-pink-500 to-yellow-300">
                    Power Your Home with the Sun: Sustainable Energy Made Simple
                  </h2>
                </div>
              </div>
                ...
                <div className="elementor-widget-container">
                  <div style={{ color: '#ffffff' }}>
                    <p className="text-lg mb-6">
                      Sustainably water your crops with our solar-powered irrigation systems. Powered by renewable energy, these systems combine efficiency with eco-friendliness, making them perfect for remote or off-grid locations.
                    </p>
