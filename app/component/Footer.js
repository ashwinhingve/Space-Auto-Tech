...
const Footer = () => {
  return (
    <>
      <footer className="bg-gradient-to-r from-blue-600 via-teal-500 to-blue-600 p-10">
        <div className="text-white body-font">
            ...
            <div className="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
              <a className="flex title-font font-bold items-center md:justify-start justify-center text-white">
                <Image
                  ...
                  height={30}
                />
                <span className="ml-3 text-2xl font-poppins">
                  Space Auto Tech
                </span>
              </a>
          ...
          <div className="footer-inner flex flex-col md:flex-row justify-between items-center mt-10 gap-6">
            <div className="copyright text-gray-100">
              <p>
                Copyright &copy; 2024, Space Auto Tech. All rights reserved.
              </p>
            </div>
